public class CalcComplex implements MathArithmetiicImag, MathArithmeticsReal {
    private double a1;
    private double b1;
    private double a2;
    private double b2;
    ...
    public CalcComplex(double a1, String operation1, double b1, String mathOperation, double a2,
                                 String operation2, double b2) {
        this.a1 = a1;
        this.b1 = b1;
        this.a2 = a2;
        this.b2 = b2;
