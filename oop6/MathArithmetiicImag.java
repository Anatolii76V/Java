public interface MathArithmetiicImag {
    default double divMulImag(double a1, double a2, double b1, double b2, String operation1, String operation2, String mathOperation) {
    ...
    default double sumSubImag(double b1, double b2, String operation1, String operation2, String mathOperation) {
        int i = 1;
